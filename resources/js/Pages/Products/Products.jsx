 ...
 export default function ProductPetShop() {
             ...
             <div className="py-12 bg-gradient-to-b from-orange-50 to-white">
                 <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                         ...
                         <div className="mt-6">
                             <div className="relative">
                                 <input
                                     ...
                                     className="w-full px-4 py-3 pl-11 border-2 border-orange-200 rounded-lg focus:ring-2 focus:ring-orange-400 focus:border-orange-400 transition-all"
                                 />
                                 <svg
                                     className="absolute left-3 top-3.5 h-5 w-5 text-orange-400"
                                     fill="none"
                                     stroke="currentColor"
                                     viewBox="0 0 24 24"
                                 >
                         ...
                         {filteredProducts.map((product) => (
                             ...
                             >
                                 ...
                                 <div className="relative h-64 bg-gradient-to-br from-orange-100 to-orange-50 overflow-hidden">
                                     ...
                                     />
                                     {product.badge && (
                                         <span className={`absolute top-3 left-3 px-3 py-1.5 text-xs font-bold rounded-full shadow-md ${
                                             product.badge === 'Sale' 
                                     ...
                                     {/* Wishlist Button */}
                                     <button className="absolute bottom-3 right-3 p-2.5 bg-white rounded-full shadow-lg hover:bg-orange-50 transition-all hover:scale-110">
                                         <svg
                     ...
                     <div className="mt-12 text-center">
                         <button className="px-8 py-3 bg-white border-2 border-orange-300 text-orange-600 rounded-lg hover:bg-orange-50 hover:border-orange-500 transition-all duration-200 font-semibold shadow-md hover:shadow-lg">
                             Load More Products
                         </button>
                     </div>
